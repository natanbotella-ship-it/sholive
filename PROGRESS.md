...
- 2026-07-05 : Revue complète du code (session Fable 5, branche `review/bugfixes-and-design`) — 15 bugs trouvés et corrigés, un commit isolé par bug. **IMPORTANT : `migrations/2026-07-05-revue-securite.sql` est à appliquer sur la base Supabase (SQL Editor ou migration MCP) AVANT de reprendre le Bloc 19** — le MCP Supabase n'était pas authentifié dans la session de revue, `schema.sql` est à jour mais la base vivante ne l'est pas.
  - **Argent / Stripe** :
